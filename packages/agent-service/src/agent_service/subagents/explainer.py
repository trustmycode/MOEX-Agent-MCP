...
Создать краткий, структурированный отчёт на {language} языке на основе предоставленных данных.
...
1. **Резюме** (2-3 предложения) — главные выводы
2. **Ключевые метрики** — описание основных показателей
3. **Риски и предупреждения** — на что обратить внимание
4. **Рекомендации** (если есть данные о ребалансировке)

## Форматирование

- Используй заголовки Markdown (##, ###)
- Выделяй важные числа **жирным**
- Избегай технического жаргона для CFO
