...
| 3 | `TASK-2025-074` | Фаза 0.5. Вынесение IssClient в `moex_iss_sdk` | 5/7/9 | Перенести существующий HTTP-клиент ISS в SDK, убрать дублирование | P0 | backlog |
| 4 | `TASK-2025-075` | Фаза 0.6. Кэш и ошибки в `moex_iss_sdk` | 5/7/9 | Добавить LRU-кэш и нормализованные исключения (`INVALID_TICKER`, `DATE_RANGE_TOO_LARGE`, …) | P0 | backlog |
